  ...
  public: {
    Tables: {
      diaries: {
        ...
        Relationships: [
          {
            foreignKeyName: "diaries_profile_id_profiles_profile_id_fk";
            columns: ["profile_id"];
            isOneToOne: false;
      ...
      diary_comments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["diary_id"];
            isOneToOne: false;
            referencedRelation: "diaries_view";
      ...
      monthly_themes: {
        ...
        Relationships: [
          {
            foreignKeyName: "monthly_themes_profile_id_profiles_profile_id_fk";
            columns: ["profile_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["profile_id"];
    ...
    Views: {
      diaries_view: {
        Row: {
          ...
          status: Database["public"]["Enums"]["diary_status"] | null;
